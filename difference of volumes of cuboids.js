...
function findDifference(a, b) {
  let firstVolume = a.reduce((acc, current) => acc * current, 1)
  let secondVolume = b.reduce((acc, current) => acc * current, 1)
  return firstVolume < secondVolume ? secondVolume - firstVolume : firstVolume - secondVolume;
}
